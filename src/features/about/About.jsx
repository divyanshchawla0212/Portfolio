...
function About() {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>Divyansh Chawla | About</title>
      </Helmet>
      <div className=" flex flex-col  items-center justify-center gap-y-4 p-8 text-textColor xl:gap-y-8 ">
        <div className="flex flex-col items-center gap-x-10 xl:flex-row">
          ...
          <div>
            ...
            <h2 className=" pt-6 text-xl delay-0 duration-1000 animate-in fade-in zoom-in max-sm:hidden">
              Hi, I&apos;m Divyansh Chawla. Final year student & Aspiring
        ...
        <div className="pt-6  xl:flex xl:gap-x-24">
          <div className="order-1 space-y-4 text-center xl:w-1/2 ">
            ...
            With extensive experience in machine learning and deep learning, I excel in
            leveraging data-driven insights to solve complex business problems. My passion lies
            in developing innovative algorithms for analyzing large datasets, particularly in
            natural language processing, computer vision, and predictive analytics. As a lifelong
            learner, I am committed to staying at the forefront of this rapidly evolving field.
            </p>
          </div>
